...
namespace Neodroid.Managers {
  ...
  public class NeodroidManager : MonoBehaviour,
    ...
    ///
    /// </summary>
    public System.Boolean AwaitingReply {
      get {
        lock (this._send_lock) {
    ...
    ///
    /// </summary>
    public System.Boolean IsSyncingEnvironments {
    ...
    /// </summary>
    /// <param name="reaction"></param>
    void OnReceiveCallback(Utilities.Messaging.Messages.Reaction reaction) {
      lock (this._send_lock) {
        #if NEODROID_DEBUG
        if (this.Debugging) {
          Debug.Log("Received: " + reaction);
        }
        #endif
    ...
    /// </summary>
    /// <param name="reaction"></param>
    protected void SetReactionFromExternalSource(Utilities.Messaging.Messages.Reaction reaction) {
      lock (this._send_lock) {
        if (reaction != null) {
          this.CurrentReactions = new[] {reaction};
          this.CurrentReactions[0].Parameters.IsExternal = true;
    ...
    public System.Boolean HasStepped { get; set; }
